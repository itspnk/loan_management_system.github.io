...
<c:url var="addUrl" value="/ctl/officer/field" />

<c:url var="addSearch" value="/ctl/officer/field/search" />

<c:url var="editUrl" value="/ctl/officer/field?id=" />

<c:url var="statusUrl" value="/ctl/officer//field/status?id=" />
...
<nav aria-label="breadcrumb">
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item linkSize active" aria-current="page"> <i class="fa fa-arrow-right" aria-hidden="true"></i>Field Officer List</li>
  </ol>
</nav>
</div>
<hr>
	<sf:form method="post"
		action="${pageContext.request.contextPath}/ctl/officer/field/search"
		modelAttribute="form">
		<div class="card">
			<h5 class="card-header bgcolor"
				style="color: white;">Field Officer List</h5>
			<div class="card-body">
				<div class="row g-3">
